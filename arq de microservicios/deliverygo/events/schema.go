...
func NewCancelledDeliveryEvent(deliveryId, orderId, userId string) *Event {
	return &Event{
		ID:         primitive.NewObjectID(),
		DeliveryId: deliveryId,
		OrderId:    orderId,
...
func NewSetOnTheGoDeliveryEvent(deliveryId, orderId, userId string) *Event {
	return &Event{
		ID:         primitive.NewObjectID(),
		DeliveryId: deliveryId,
		OrderId:    orderId,
...
func NewSetDeliveredDeliveryEvent(deliveryId, orderId, userId string) *Event {
	return &Event{
		ID:         primitive.NewObjectID(),
		DeliveryId: deliveryId,
		OrderId:    orderId,
